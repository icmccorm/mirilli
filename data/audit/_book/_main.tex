...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{by\_count }\OtherTok{\textless{}{-}}\NormalTok{ foreign\_abis }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{group\_by}\NormalTok{(crate\_name) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{summarize}\NormalTok{(}\AttributeTok{n=}\FunctionTok{n}\NormalTok{())}
